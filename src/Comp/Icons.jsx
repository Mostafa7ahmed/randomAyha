...
export const VolumeIcon = ({ onClick }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="20" width="24" className="volume_button" onClick={onClick}>
...
export const PlayIcon = ({ onClick }) => (
    ...
    <img src={require("./Vector.png")} height="24" width="24" onClick={onClick} alt="" />

);

export const PauseIcon = ({ onClick }) => (
    <img src={require("./Vector2.png")} height="24" width="24" onClick={onClick} alt="" />
...
export const HeartIcon = ({ onClick }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" className="heart" onClick={onClick} stroke="currentColor" height="20" width="24">
